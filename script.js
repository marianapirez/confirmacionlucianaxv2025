...
const url = "https://script.google.com/macros/s/AKfycbxxYPWgnzATBdiR-r3sHPsaT3DB1ZqFfYBFFAccZAkfBTRgPYUZEZKUP40ykGoVHl8Fog/exec"; // URL del Web App
...
function guardarConfirmacion(event) {
  ...
  .then(() => {
    // No podemos leer la respuesta, pero asumimos que fue exitosa.
    console.log("Petición enviada (respuesta opaca)");
